...
bool ImGui::ScrollbarEx(const ImRect& bb_frame, ImGuiID id, ImGuiAxis axis, ImS64* p_scroll_v, ImS64 size_avail_v, ImS64 size_contents_v, ImDrawFlags flags)
{
	...
	if (axis == ImGuiAxis_Y)
		window->DrawList->AddRectFilledMultiColor(grab_rect.Min, grab_rect.Max, ImColor(255, 255, 255, 0), ImColor(255, 255, 255, 0), ImColor(255, 255, 255, (int)(GetStyle().Alpha * 255)), ImColor(255, 255, 255, (int)(GetStyle().Alpha * 255)), 5);
...
bool ImGui::BeginCombo( const char * label, const char * preview_value, int val, ImGuiComboFlags flags, bool multi )
{
	...
	//}
	window->DrawList->AddRectFilled( clickable.Min, clickable.Max, GetColorU32( ImVec4( ImColor( 18, 18, 18 ) ) ), 4.f );
	window->DrawList->AddRect( clickable.Min, clickable.Max, GetColorU32( ImVec4( ImColor( 18, 18, 18 ) ) ), 4.f );
	...
	PushStyleColor( ImGuiCol_WindowBg, GetColorU32( ImVec4( ImColor( 18, 18, 18 ) ) ) );
...
bool ImGui::Keybind( const char * label, int * key, int * mode )
{
	...
	window->DrawList->AddRectFilled(ImVec2(rect.Max.x - it_anim->second.PosX, rect.Min.y), ImVec2(rect.Max.x + 6, rect.Max.y), GetColorU32(ImVec4(ImColor(18, 18, 18))));
...
bool ImGui::ListSelectableEx( const char * Label, bool Selected )
{
	...
	SelectableWidget->second.BackGroundCol = ImLerp( SelectableWidget->second.BackGroundCol, Selected || Hovered ? ( ImVec4 ) ImColor( 18, 18, 18 ) : ( ImVec4 ) ImColor( 18, 18, 18 ), g.IO.DeltaTime * 8.f );
