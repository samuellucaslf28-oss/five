...
#include <Core/Features/Visibility.hpp>
#include <d3dx11.h>
#include <d3d11.h>
#include <D3DX11tex.h>
#include <D3dx9math.h>
...
inline CPed* GetClosestPed(int MaxDistance, bool IgnoreNpc, bool VisibleCheck, bool PrioritizeFOV = true)
{
...
continue;
if (VisibleCheck && !Core::Features::Visibility::IsVisible(Ped))
continue;
...
float Metric = PrioritizeFOV ? AimDist : Entity.Distance;
if (Metric < ClosestDist)
{
ClosestDist = Metric;
ClosestPed = Ped;
}
...
inline bool HasLineOfSight( D3DXVECTOR3 StartPos, D3DXVECTOR3 EndPos )
{
...
if ( distance > 0.1f && EndPos.z >= StartPos.z - 2.0f )
{
return true;
}
return false;
